...
//     while (true) {
//       const currentPageURL = `${url}?page=${pageCounter}`;
//       console.log(currentPageURL);
//       await page.goto(currentPageURL, { timeout: 0, waitUntil: 'domcontentloaded' });
...
//       const hasNextPage = await page.$(req.body.paginationclass);
//       if (!hasNextPage) {
//         break;
//       }
...
// //   const images = document.querySelectorAll('.ui-item__image');
// //   return Array.from(images).every(img => img.src && !img.src.startsWith('data:image'));
// // }, { timeout: 60000 });
